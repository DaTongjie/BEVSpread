...
Ref:https://github.com/charlesq34/frustum-pointnets/tree/master/mayavi
'''
...
def draw_lidar(pc, color=None, fig=None, bgcolor=(0,0,0), pts_scale=1, pts_mode='point', pts_color=None, show=False):
    ''' Draw lidar points
    Args:
...
def draw_gt_boxes3d(gt_boxes3d, fig, color=(1,1,1), line_width=2, draw_text=False, text_scale=(1,1,1), color_list=None):
    ...
    Args:
        ...
        color: RGB value tuple in range (0,1), box line color default: white
...
def draw_pred_boxes3d(gt_boxes3d, fig, color=(1,1,1), line_width=2, draw_text=False, text_scale=(1,1,1), color_list=None):
    ''' Draw 3D bounding boxes
    Args:
        gt_boxes3d: numpy array (n,8,3) for XYZs of the box corners
        fig: mayavi figure handler

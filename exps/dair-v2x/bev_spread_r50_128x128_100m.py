...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='./outputs/bev_spread_r50_128x128_100m/checkpoints', filename='{epoch}', every_n_epochs=1, save_last=False, save_top_k=-1)
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='./outputs/bev_spread_r50_128x128_100m')

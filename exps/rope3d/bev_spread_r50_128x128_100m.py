...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='./outputs/rope3d/bev_spread_r50_128x128_100m', filename='{epoch}', every_n_epochs=1, save_last=True, save_top_k=-1)
...
def run_cli():
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='./outputs/rope3d/bev_spread_r50_128x128_100m')

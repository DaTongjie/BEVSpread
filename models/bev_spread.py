...
from layers.heads.bev_head import BEVHead

__all__ = ['BEVSpread']


class BEVSpread(nn.Module):
    """
    Args:
    ...
    def __init__(self, backbone_conf, head_conf, is_train_height=False):
        super(BEVSpread, self).__init__()
        self.backbone = LSSFPN(**backbone_conf)
        self.head = BEVHead(**head_conf)
    ...
    def forward(
        ...
        """Forward function for BEVSpread
